...
<body
    class="mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-200 from-10% via-purple-200 via-30% to-pink-200 to-90% text-slate-700">
    ...
    <div class="hidden sm:flex sm:items-center sm:ml-6">
                    @auth
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('my-job.index')">
                                    {{ __('My Jobs') }}
                                </x-dropdown-link>
